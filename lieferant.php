...
if (isset($_POST['action'])) {
    ...
    $strasse = !empty($_POST['strasse']) ? filter_var($_POST['strasse'], FILTER_SANITIZE_SPECIAL_CHARS) : "N/A";
    $plz = !empty($_POST['plz']) ? filter_var($_POST['plz'], FILTER_SANITIZE_SPECIAL_CHARS) : "N/A";
    $ort = !empty($_POST['ort']) ? filter_var($_POST['ort'], FILTER_SANITIZE_SPECIAL_CHARS) : "N/A";
    $kontakt = !empty($_POST['kontakt']) ? filter_var($_POST['kontakt'], FILTER_SANITIZE_SPECIAL_CHARS) : "N/A";
    $tel = !empty($_POST['tel']) ? filter_var($_POST['tel'], FILTER_SANITIZE_SPECIAL_CHARS) : "N/A";
    $web = !empty($_POST['web']) ? filter_var($_POST['web'], FILTER_SANITIZE_SPECIAL_CHARS) : "N/A";
        ...
        <form id="lp-form" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
            <div class="row">
                <div class="input-field col s12 m6 l4">
                    <input type="hidden" name="lieferant_id" value="<?php echo isset($_GET['id']) ? $_GET['id'] : "NULL"?>">
                    ...
                    <input id="firma" name="firma" type="text" value="<?php echo isset($_POST['firma']) || isset($_GET['id']) ? $firma ? $firma : '' : ''; ?>" maxlength="25" required>
                    <label for="firma">Firma</label>
                </div>
                <div class="input-field col s12 m6 l4">
                    <input id="strasse" name="strasse" type="text" maxlength="60" value="<?php echo isset($_POST['strasse']) || isset($_GET['id']) ? $strasse ? $strasse : '' : ''; ?>">
                    <label for="strasse">Strasse und Hausnummer</label>
                </div>
                <div class="input-field col s12 m6 l4">
                    <input id="plz" name="plz" type="text" maxlength="10" value="<?php echo isset($_POST['plz']) || isset($_GET['id']) ? $plz ? $plz : '' : ''; ?>">
            ...
            <div class="row">
                <div class="input-field col s12 m6 l4">
                    ...
                    <input id="ort" name="ort" type="text" value="<?php echo isset($_POST['ort']) || isset($_GET['id']) ? $ort ? $ort : '' : ''; ?>" maxlength="40">
                    <label for="ort">Ortschaft</label>
                </div>
                <div class="input-field col s12 m6 l4">
                    <input id="kontakt" name="kontakt" type="text" maxlength="40" value="<?php echo isset($_POST['kontakt']) || isset($_GET['id']) ? $kontakt ? $kontakt : '' : ''; ?>">
                    <label for="kontakt">Ansprechpartner</label>
                </div>
                <div class="input-field col s12 m6 l4">
                    <!--Bei Chrome funktioniert das html5 maxlenght nur bei text, desshalb js-->
                    <input id="tel" name="tel" type="text" maxlength="15" value="<?php echo isset($_POST['tel']) || isset($_GET['id']) ? $tel ? $tel : '' : ''; ?>"  maxlength="25">
            ...
            <div class="row">
                <div class="input-field col s12 m6 l4">
                    <!--Bei Chrome funktioniert das html5 maxlenght nur bei text, desshalb js-->
                    <input id="web" name="web" type="text" maxlength="40" value="<?php echo isset($_POST['web']) || isset($_GET['id']) ? $web ? $web : '' : ''; ?>" maxlength="25">
